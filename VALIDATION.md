...
Ursprüngliches Änderungspaket vom 22. September: `npm ci --ignore-scripts` und `npm test`: **57 Tests bestanden**, einschliesslich elf zusätzlicher Karten- und Übergabetests. Der aktuelle Gesamtstand mit Fachfilter und erweiterten Quellen umfasst **207 bestandene Tests** (siehe unten).
...
## Erster veröffentlichter Feed und Browserprüfung – 24. September 2026

- Dieser erste Feed war noch nicht fachlich gefiltert. Seine Inseratzahl belegt keine gesundheitsökonomische Relevanz.
...
- Weitere Anbindungen für weiterhin nicht bzw. teilweise erfasste Quellen. KPT und mehrere weitere Einstiege sowie PDF-Inserate wurden im nachfolgenden Korrekturlauf bearbeitet. Robots-/Zugangssperren bleiben respektiert. Vereinzelte HTML-Zeichenreferenzen in Quelltexten benötigen noch eine vollständigere Textaufbereitung.

## Fachfilter und erweiterte Quellen – 24. September 2026

- Ursache der fachfremden Treffer bestätigt: Der erste öffentliche Feed grenzte Arbeitgeber und Bereiche ein, bewertete aber nicht konsequent die konkrete Funktion. Der gemeinsame Volltextfilter schliesst jetzt fachfremde Tätigkeiten aus und liefert pro Stelle Fachbereich und Begründung. Im alten Bestand passieren **27 von 1.075** Inseraten die neue Regel; **1.048** werden ausgeschlossen.
- Regressionen decken Pflege und klinische Führung, zwingende klinische Diplome, allgemeine Verwaltung/Verkauf/IT, andere Versicherungsbereiche, irreführende Arbeitgeberwerbung sowie passende fachliche Projektleitung und alternative Studienabschlüsse ab. Alte fachfremde Inserate werden auch bei fehlgeschlagenem oder nicht gewähltem Quellenabruf entfernt.
- Neue HTML-Anbindungen: Umantis/ÖKK/St. Gallen, Abacus/FMH, Solique/KSW, HOCH und Hirslanden mit belegter Pagination; SRK/Rexx mit bereinigter Navigation. Native Detailvorlagen für Uni Luzern, ZHAW/WIG und santéservices erschlossen. PDF-Inserate werden begrenzt und unter den bestehenden Netzwerkregeln gelesen. KPT, Helsana sowie die Bundesamtsfilter für SECO und BFS korrigiert.
- **207 Regressionstests lokal bestanden.** Der Quellenbestand bleibt unabhängig vom Fachfilter bewertet: null passende Stellen bedeutet nicht, dass ein Arbeitgeber keine offenen Stellen hat. Nicht ausgelesene eingebettete Listen und verlorene Filter bei Weiterleitungen verhindern falsche Vollständigkeit.
- Vollständiger neuer Crawl und Browserprüfung: [Lauf 35972131067](https://github.com/salmonplnk/Jobs-Gesundheitsoekonomie-politik-management/actions/runs/35972131067), Codecommit `d9ae38369cca961cbe795bef324f2475ff8fa4d7`. Dieser Lauf bestand die Regressionen sowie alle zwölf Chromium-Prüfungen mit dem echten Feed. Die Sichtprüfung der 39 Ergebnisse führte anschliessend zu zwei gezielten Ausschlüssen und einer Korrektur der technischen Quellenabdeckung (siehe unten).

- Gesamtabruf 07:54–08:08 UTC: **1.789 eindeutige Rohinserate**, verwertbare Inserate aus **40 statt zuvor 26 Quellen**. Alle 85 Quellen wurden versucht. Die Nachprüfung lässt **37 Stellen aus zwölf Quellen** zu; **1.752 Inserate** sind ausgeschlossen. Studienadministration und betriebliches Sicherheitsmanagement wurden nach Volltextprüfung ausdrücklich ausgeschlossen. Tumordaten-Auswertung mit offenem nichtklinischem Ausbildungspfad bleibt zugelassen.
- Korrigierte technische Abdeckung: **29 vollständig erfasste Quellen** (25 mit Rohinseraten, vier ausdrücklich leer), **15 teilweise erfasst**, **29 nicht unterstützt**, **12 Abruffehler**. Vier Einträge besitzen kein Stellenportal und sind in den nicht unterstützten Quellen enthalten. Das ist weiterhin keine Vollabdeckung. Zuvor waren 21 Quellen vollständig und acht teilweise erfasst.
- Bei Krebsliga war die Ostendis-Signatur zunächst falsch interpretiert: Der Selektor ist das dritte Argument. Der korrigierte Parser ist am gespeicherten Original-HTML und einem Crawlerfall mit PDF geprüft. Die Quelle ist teilweise erfasst; ihre frühere Vollständigkeitsbehauptung wird zurückgenommen.
- Helsana ist trotz des korrigierten Einstiegs im automatischen Abruf gesperrt (`robots.txt: Disallow: /`); santéservices lief bei den Detailabrufen in Zeitlimits. Die erfolgreiche gezielte HTML-Prüfung wird nicht als erfolgreicher Gesamtcrawl dieser Quellen dargestellt.
- Vier Feed-Screenshots (Desktop/Mobil, hell/dunkel) visuell geprüft: keine abgeschnittenen Bedienelemente oder Überlagerungen. Die zwölf automatischen Browserprüfungen umfassen Fachfilter, getrennte Zähler, Pagination und Volltextimport.
- Abschliessende Veröffentlichung erfolgreich: [Review-Lauf 35974191089](https://github.com/salmonplnk/Jobs-Gesundheitsoekonomie-politik-management/actions/runs/35974191089), Codecommit `d234d3ec728ea840720bc02c98357d2818816c76`, Datencommit `cc0c987d2957dd42d9a1c3e20152fe5a1b3aff1d`. **207 Regressionstests und zwölf Browserprüfungen bestanden.** Das frische Ausgangsartefakt wurde anhand SHA-256 und bytegleichem Datencommit geprüft; die Nachprüfung enthält keine neuen Abrufe und behält die ursprünglichen Quellenzeiten bei.
- Alle **86 veröffentlichten JSON-Dateien** stimmen per Git-Blob-Hash mit dem geprüften Review-Artefakt überein. Die öffentliche Standardadresse liefert HTTP200, CORS `*` und exakt den geprüften Index mit **37 Inseraten**, **1.752 Ausschlüssen** und den korrigierten Quellenzählern. Neue Desktop-/Mobil-Screenshots nochmals visuell geprüft. Main, Supabase und die Freigabe der gesamten Anwendung bleiben unverändert offen.
